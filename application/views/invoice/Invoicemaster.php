...
<div class="tab-content" id="myTabContent">
  ...
  <div class="tab-pane fade mt-2 ms-2 me-2" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
    ...
    <form class="mt-3 p-4 shadow-sm" id="addupdateForm">
      ...
      <!-- code written for practice by  2023-12-22-->

      <div class="addMoreDiv" style="border: 1px solid red; height: 150px; width: 100%;">
          <table id="tableIdAddMore" style="width: 100%;">

            <thead style="border: 1px solid blue; height: 50px; width: 100%">
                <tr>
                  <td>List</td>
                </tr>
            </thead>
            ...
            <tbody id="TbodyAddRow">
                <tr>
                  <td>
                    <input type="text" placeholder="Testing Only" name="testing[]">
                  </td>

                  <td align="center">
                    <button type="button" class="btn btn-danger btn-sm removeBtnpractice" onClick="tbodyRemove(this)"><i class="fa fa-trash"></i></button>
                  </td>
                </tr>
            </tbody>
            ...
            <tfoot>
              <tr>
                <td colspan="2" align="right">
                  <input type="button" class="btn btn-success btn-sm tbodyAddRow" value="Add More" style="margin-right:700px;" />
                </td>
              </tr>


                <td>
                  <input type="hidden" name="form_actionTbody" id="form_actionTbody" value="addTbody">
                  <button type="button" class="btn btn-primary btn-sm" id="addbtn" onclick=" AddinvoiceitemlistTbody()">Submit </button>
                  <button type="button" class="btn btn-info btn-sm" id="updatebtn" style="display:none;" onclick="updateinvoiceTbody()">Update</button>
                </td>
            </tfoot>
      ...
      <!-- code written end by 2023-12-22 -->
...
<!-- script practice by 2023-12-22 -->

  <script>
    $(".tbodyAddRow").click(function(){
    var printdata = $(this).closest("div.addMoreDiv");
    var tabletrtheadtbody = printdata.find("table tbody tr:first-child");
    var tabletrthead = tabletrtheadtbody.clone();
    tabletrthead.find("input[type='text']").val('');

    printdata.find("table tbody").append(tabletrthead);
    $('.removeBtnpractice').removeClass('disabled');
    });


    function tbodyRemove(fld){
      var printdata = $(fld).closest("div.addMoreDiv");
      var trlengthChecking = printdata.find("table tbody").children('tr').length;
      if(trlengthChecking > 1){
...
<!-- script practice end by 2023-12-22 -->
<script>
