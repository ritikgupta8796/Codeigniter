...
// $nameGraph = $this->Usermaster_Model->$nameGraphModel();
// print_r($nameGraph);die;
...
<div class="content-inner w-100">
        ...
        <div class="ps-2 pe-2 ">
            ...
            <div class="tab-content " id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab" tabindex="0">
                    ...
                    <div class="ps-0 pe-2 rounded card" style="margin-top: 15px">    <!--margin-top: -15px    phlae yeh tha  -->
    ...
    var options = {
        ...
        xaxis: {
          categories: [<?php echo json_encode($nameGraph); ?>],
        },
        yaxis: {
          title: {
            text: '$ (thousands)'
